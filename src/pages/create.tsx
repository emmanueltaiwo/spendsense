...
import CreateExpensesLayout from "@/components/CreateExpenses/createExpensesLayout";
...
const Create = () => {
  ...
  useEffect(() => {
    ...
    localStorage.setItem("page_name", "Create");
  }, []);
  ...
  return (
    <>
      <Head>
        <title>SpendSense - Create Expenses</title>
      </Head>
